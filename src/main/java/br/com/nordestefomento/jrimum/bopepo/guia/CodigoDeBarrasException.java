...
/**
 * <p>
 * Qualquer exceção gerada durante a geração do Código de Barras gera uma <code>CodigoDeBarrasException</code>. 
 * Centraliza e localiza os problemas relativos a geração de um código de barras.
 * </p>
 * 
...
public class CodigoDeBarrasException extends RuntimeException {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 468686244682182128L;
