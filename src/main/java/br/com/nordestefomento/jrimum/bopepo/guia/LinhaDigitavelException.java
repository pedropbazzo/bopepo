...
/**
 * <p>
 * Qualquer exceção gerada durante a geração da Linha Digitável gera uma <code>LinhaDigitavelException</code>. 
 * Centraliza e localiza os problemas relativos a geração de uma linha digitável.
 * </p>
 * 
...
public class LinhaDigitavelException extends RuntimeException {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6878428688316735328L;
