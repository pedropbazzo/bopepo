...
/**
 * <p>
 * Interface comum para todos os campos livres do Banco do Brasil que venham a
 * existir.
 * </p>
 *
        ...
        switch (titulo.getNossoNumero().length()) {
            ...
            default:
                if (ConfiguracaoJRimum.preferirDefaultEmCampoLivre) {
                    log.warn("Não foi possivel identificar o tamanho do nosso numero usando default: CLBancoDoBrasilNN10");
                    return new CLBancoDoBrasilNN10(titulo);
                }
