...
public class LayoutsSuportados {
    ...
    public static TagLayout LAYOUT_FEBRABAN_REMESSA_COBRANCA_CNAB240 = flatfile(
            ...
            cabecalhoLote(
                    ...
                    field("ocorrencia").length(10).filler(Fillers.WHITE_SPACE_LEFT)
            ),
            ...
            tituloJ(
                    ...
                    field("sacado").length(30),
                    field("dataVencimento").length(8).format(new SimpleDateFormat("ddMMyyyy")),
                    field("valor").length(15).format(new DecimalFormat("000000000000000")).type(Number.class
                    ),
                    ...
                    field("valorDesconto").length(15).format(new DecimalFormat("000000000000000")).type(Number.class
                    ),
                    //Valor da Mora + Multa
                    //Valor do juros de mora somado ao Valor da multa, expresso em moeda corrente
                    field("valorAcresciomo").length(15),
                    field("dataPagamento").length(8),
                    field("valorPagamento").length(15),
                    ...
                    field("numeroDocumento").length(20),
                    ...
                    /*
                    Domínio:
                            '00' = Crédito ou Débito Efetivado → Este código indica que o pagamento foi
                            confirmado
                            ...
                            ‘ZB’ = Divergência entre o primeiro e último nome do beneficiário versus primeiro e
                            último nome na Receita Federal
            ...
            tituloJ52(
                    ...
                    //                   '3'  =  PIS / PASEP
                    //                   '9'  =   Outros
                    field("tipoInscricaoSacado").value("2").value(""),
                    field("sacadoCpf").length(15).padding(Fillers.ZERO_LEFT),
                    field("sacado").length(40),
                    //DADOS DO BENEFICIARIO
                    field("tipoInscricaoCedente").value("2").value(""),
                    field("cedenteCnpj").length(15).padding(Fillers.ZERO_LEFT),
                    field("cedente").length(40),
                    //DADOS DO PAGADORR
                    //Pagadorr - Dados sobre o Beneficiário responsável pela emissão do título original
                    field("tipoInscricaoPagadorr").value("2").value(""),
                    field("pagadorrCnpj").length(15).padding(Fillers.ZERO_LEFT),
            ...
            rodapeLote(
                    ...
                    field("numAvisoDebito"),
                    field("").length(165).filler(Fillers.WHITE_SPACE_LEFT),
