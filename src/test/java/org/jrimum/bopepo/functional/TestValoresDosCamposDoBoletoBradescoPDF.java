...
public class TestValoresDosCamposDoBoletoBradescoPDF {
    ...
    /**
     * Por definição, o pdf do boleto contém apenas duas imagens: logo do banco
     * e o código de barras.
     *
     * @throws IOException
     */
    @Ignore//TODO: Braully-- Erro depois da atualizar o itext
    //http://itext.2136553.n4.nabble.com/Reading-text-from-PDF-td2528925.html
    //FIXME: Corrigir futuramente
    @Test
    ...
    public void deve_gerar_boleto_com_codigo_de_barras() throws IOException {
        ...
        byte[] pdfAsByteArray = boletoViewer.getPdfAsByteArray();
        Map<String, Collection<BufferedImage>> imagesMap = PDFs.getImages(pdfAsByteArray);
